      ...
      <div class="row">
        <div class="col-left background-4">
          <div class="banner-description-container">
            <h2>C'EST PARTIE!</h2>
            <P>DEMANDEZ UN PICKUP EN QUELQUE CLICKS SEULEMENT!</P>
          </div>
        </div>
        <div class="col-right">
...
.africa-background {
  background-image: url("../images/Africa background.png");
  /* background-position: center; */
  background-repeat: no-repeat;
  /* background-size: cover; */
...
.express-container .icn-express {
  background-image: url("../images/Airplane simbol.png");
  background-size: cover;
  height: 30px;
  width: 30px;
  margin-top: 4px;
...
.packet-container .icn-small-packet {
  background-image: url("../images/Small envelope closed.png");
  display: inline-block;
  /*height: 30px;
  width: 30px;*/
  height: 35px;
...
.product-container .icn-small-product {
  background-image: url("../images/Small envelope open.png");
  display: inline-block;
  height: 49px;
  width: 49px;
  background-repeat: no-repeat;
...
.page-6 .pickup-container .icn-tag {
  /* background-image: url("../images/Coutera icon.png");*/
  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;
  height: 30px;
...
export default {
  ...
  methods: {
    ongotoNextPage() {
        ...
        if (!this.is_envelope && !this.is_package) {
            this.$toast.error('VOus devez sélectionner au moins un des types.');
            return
        }
        ...
        if (this.is_package == true) {
            ...
            this.$router.push("/envelop_package_data");
        }
    },
  },
};
