      ...
      <div class="row">
        ...
        <div class="col-right">
          ...
          <form
            ...
            @submit.prevent="onSubmitEnvelopeForm()"
          >
            <div
            ...
            >
              <div class="packet-container" id="packet-container">
                ...
                <div id="packet-form-group-row-container">
                  <div
                    class="my-form-row form-group-row"
                    id="packet-form-group-row"
                  >
                    <div class="form-group">
                      <div class="my-env-row">
                        <label class="styled-checkbox">
                          <input
                            type="checkbox"
                            v-model="wrapper.is_smallformat"
                        ...
                        <div>
                          <img
                            src="./assets/Envelope grand format.png"
                            height="28"
                          />
                        </div>
                        <p>Petit Formate</p>
                  ...
                  <div class="" id="right-checkbox-label-child-container">
                    ...
                    <label class="styled-checkbox">
                      ...
                      <input
                        ...
                        v-model="wrapper.is_noorigincertificat"
                      />
                      <div class="checkbox"></div>
                    </label>
                  </div>
              ...
              <div class="note-container">
                <p class="note">
                  Si Alimentaire,fournir un certificat phytosaritaire ou nous en
                  demander
                </p>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    gotopackageform() {
      (this.is_envelope = false), this.$router.push("/packageform");
    },
