<template>
 <div class="page-7">
    <div class="wrapper">
      <div class="row">
        <div class="col-left background-7">
        ...
        <div class="col-right">
          ...
          <nav class="navbar nav-left">
            ...
            <ul class="nav">
              <li class="excellent">
                <a href="#"><i class="far fa-smile"></i> excellent!</a>
              </li>
            </ul>
          </nav>
          <div class="container">
            <p class="confirmation-message">
              DEMANDEZ MAINTENANT UN PICK UP EN QUELQUES CLICKS !
            </p>
            <div class="step-container">
              <p class="one"><span>1 </span></p>
              <p class="description">cliquez ici en bas pour commencer votre demander de pick up</p>
              <div class="checkboxes">
                
                <label class="styled-checkbox">
                  <span></span>
                  <button type="submit" @click="gotoinfoforshipment">
                    DEMANDEZ UN PICK UP
                  </button>
                </label>
              </div>
            ...
            <div class="step-container">
              <p class="two"><span>2 </span></p>
                si vs souhaitez aussi recevoir votre facture par email cliquez ici 

              <p class="description">
                <label class="styled-checkbox">
                  <span></span>
                  <button type="submit" @click="gotoemailpage">
                    RECEVOIR PAR EMAIL
                  </button>
                </label>
              </p>
...
.styled-checkbox button[type="submit"]:hover{
    background: #eb954b;
}
...
.styled-checkbox button[type="submit"]:checked + .checkbox {
  background-color: #000;
}
.styled-checkbox button[type="submit"]:checked + .checkbox::after {
  content: "\2714";
  color: #fff;
  font-size: 18px;
  position: absolute;
