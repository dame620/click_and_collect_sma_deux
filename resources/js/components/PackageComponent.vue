    ...
    <div class="wrapper" v-if="data_loading == true">
      <div class="row">
        ...
        <div class="col-right">
              ...
              <div class="envelop">
                ...
                <label
                  ...
                  <input
                    type="checkbox"
                    v-model="is_envelope"
                    @click.prevent="gotoenvelopeform()"
                  />
          ...
          <form
            @submit.prevent="onSubmitPackageForm()"
            class="delivery-info-form"
          >
            <div
              class="delivery-info-form-container"
              v-for="(wrapper, wrapper_index) in wrappers"
              :key="wrapper_index"
            >
              <!--start select-->
              <div class="select-form-container"></div>
              <!--end select-->
                ...
                <div id="packet-form-group-row-container">
                  ...
                  <div class="my-row form-group-row">
                        <div class="form-group">
                          <label for="">DATE D'ENVOI
                              <input type="date" class="form-control" placeholder="code postal" v-model="wrapper.pickupdates"  required> 
                          </label>
                        </div>
                  </div>
                  ...
                  <div class="form-group-row">
                    ...
                    <div class="form-group">
                      ...
                      <country-select
                        v-model="wrapper.destinationcountry"
                  ...
                  <div class="form-group-row">
                    ...
                    <div class="form-group">
                      ...
                      <region-select
                        v-model="wrapper.destinationregion"
                        :country="wrapper.destinationcountry"
                        :regionName="true"
              ...
              <div class="product-container" id="product-container">
                <div class="packet-heading-row">
                  ...
                  <div class="heading-container">
                    <button
                      type="button"
                      @click.prevent="decrementProduct(wrapper_index)"
                    >
                    ...
                    <button
                      type="button"
                      @click.prevent="incrementProduct(wrapper_index)"
                    >
                ...
                <div
                  id="product-form-group-row-container"
                  v-for="(product, product_index) in wrapper.products"
                  :key="product_index"
                >
                  <div class="form-group-row">
                      <div class="form-group">
                          <label for="">Nature du Produit</label>
                          <select  id="" class="select-dropdown" name="product_type"  v-model="product.product_type">
                            <option v-for="(listValue, listvalue_key) in valuesList" :value="listValue" :key="listvalue_key">
                                {{listValue}}
                            </option>
                          </select>
                      </div>
              ...
              <div class="my-col checkbox-container">
                <div class="left-col" id="checkbox-left-col">
                  <label class="styled-checkbox">
                    <span>Ajouter un certificat phythosanitaire</span>
                    <input
                      type="checkbox"
                      v-model="wrapper.is_phythoexiste"
                  ...
                  <div class="" id="left-checkbox-label-child-container">
                    <label
                      ...
                      v-if="wrapper.is_phythoexiste"
                    >
                      <span>Vouz avez votre phytho</span>
                      <input
                        type="checkbox"
                        :disabled="wrapper.is_phytho_provide_tosma == true"
                        v-model="wrapper.is_phytho_your_own"
                      />
                      <div class="checkbox"></div>
                    </label>
                    ...
                    >
                      ...
                      <input
                        type="checkbox"
                        v-model="wrapper.is_phytho_provide_tosma"
                ...
                <div class="right-col" id="checkbox-right-col">
                  <label class="styled-checkbox">
                    <span>Ajouter un certificat d'origine</span>
                    <input
                      type="checkbox"
                      v-model="wrapper.is_origincertificat"
                  ...
                  <div class="" id="right-checkbox-label-child-container">
                    <label
                      class="styled-checkbox"
                      v-if="wrapper.is_origincertificat"
                    >
                      <span>Vouz avez votre cert origine</span>
                      <input
                        type="checkbox"
                        :disabled="
                          wrapper.is_origin_certificat_provide_to_sma == true
                        "
                        v-model="wrapper.is_origin_certificat_your_own"
                      />
                      <div class="checkbox"></div>
                    </label>
                    <label
                    ...
                    >
                      ...
                      <input
                        type="checkbox"
                        v-model="wrapper.is_origin_certificat_provide_to_sma"
                        :disabled="
                          wrapper.is_origin_certificat_your_own == true
                        "
                      />
                      <div class="checkbox"></div>
                    </label>
...
export default {
      ...
      wrappers: [
        {
          ...
          products: [
            {
              product_type: 'Selectionner un produit',
              quantity: null,
              description: null,
              unit_price: null,
            },
  ...
  methods: {
    ...
    onSubmitPackageForm() {
       //formated information for dhl api
        ...
        //fetch request
          const formattedWrappers = this.wrappers.map(function(wrapper) {
        return {
            width:  wrapper.width,
      ...
      .then(data => {
         ...
         // this.sum_for_total_price_all_taxe=(sum_for_total_price_taxe.toLocaleString('it-IT', {style: 'currency', currency: 'XOF'})) 
          this.sum_for_total_price_all_taxe=sum_for_total_price_taxe
...
.africa-background {
  background-image: url("./assets/Africa background.png");
  /* background-position: center; */
  background-repeat: no-repeat;
  /* background-size: cover; */
...
.envelop input[type="checkbox"],
.packet input[type="checkbox"] {
  font-size: 15px;
  margin-top: 5px;
  display: none;
}
...
.envelop input[type="checkbox"]:checked + .checkbox,
.packet input[type="checkbox"]:checked + .checkbox {
  background-color: #000;
}
.envelop input[type="checkbox"]:checked + .checkbox::after,
.packet input[type="checkbox"]:checked + .checkbox::after {
  content: "\2714";
  color: #fff;
  font-size: 18px;
  position: absolute;
...
.product-container .heading-container p {
  padding: 5px 10px 0;
  text-transform: uppercase;
  font-weight: bold;
}

.packet-container .heading-container .minus,
.product-container .heading-container .minus {
  background: #e29854;
  border-radius: 50%;
  padding: 8px;
  color: white;
}
.packet-container .heading-container .plus,
.product-container .heading-container .plus {
  background: #8a7272;
  border-radius: 50%;
  padding: 8px;
  color: white;
...
.checkbox-container .right-col .styled-checkbox {
...
.checkbox-label-child-container {
  display: none;
}
/* .checkbox-container .left-col,
.checkbox-container .right-col {
