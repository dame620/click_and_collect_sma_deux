      ...
      <div class="row">
        ...
        <div class="col-right">
          ...
          <div class="calender-container">
            ...
            <p class="calender-description">
              Attention ce prix n'inclut pas les frais de douanes
            </p>
          ...
          <div class="pickup-container">
            <p class="pickup-bar">
              ...
              <strong>Votre éxpédition coûtera:</strong> 
              <strong style="background-color:#eb954b; width: 123px; height: 31px; margin-left:10px; padding-left:15px;"> {{ sum_for_total_price_all_taxe }} </strong>
            </p>
            <div class="checkboxes">
              <label class="styled-checkbox">
                <span></span>
                <button type="submit"  @click="gotonextpage" style="height:50px;">
          ...
          <div class="pickup-container">
            <p class="pickup-bar">
              ...
              CLICK AND COLLECT AFRICA C'EST L'AFRIQUE TOUT ENTIER
            </p>

            <label class="bottom_button_contain">
                <span>
...
.bottom_button_contain {
  display:flex; 
  justify-content: center;
}

.bottom_button_contain button[type="submit"]{
 margin-top:50px; 
 margin-left:57px; 
 margin-bottom:25px ;
 height:50px; 
