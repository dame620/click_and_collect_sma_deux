    ...
    <div class="main-bg">
        <div class="banner">
            <div class="banner-description">
                <h1>BIENVENUE</h1>
                <button><i class="fa fa-hand-o-down" aria-hidden="true"></i>
                  GLISSEZ VERS LE BAS POUR COMMENCER! <i class="fa fa-hand-o-down" aria-hidden="true"></i>
                </button>
            </div>
        </div>
        <div class="africa-background">
            <div class="button-container">
                <router-link tag="button" class="btn-quote" to="/check">
                    OBTENIR UNE QUOTATION
                </router-link>
                <router-link tag="button" class="btn-pickup" to="/checkforpickup">
                    DEMANDER UN PICK UP
                </router-link>
            </div>
        </div>
...
export default {
    mounted() {
      ...
      // console.log(data.toLocaleString('it-IT')) 
      var moment = require('moment');
     console.log(moment())// .format();
     console.log(moment.utc('01/12/2016', 'DD/MM/YYYY', true).format())
