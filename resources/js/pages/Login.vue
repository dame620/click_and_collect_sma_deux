...
<div class="wrapper">
    ...
    <div class="col-right">
        ...
        <div>
            <form method="POST" @submit.prevent="onLogin" novalidate>
            ...
            <button type="submit" class="btn-connection">Connexion</button>
            ...
            <div class="social-connection-container">
                ...
                <!--router-link class="registration" to="/register">INSCRIPTION</router-link-->
            </div>
        </div>
            ...
            onLogin() {
              this.form.post('/login').then(({data}) => {
                if (data.success) {
                 ...
                 if(this.prevRoute.path==='/invoiceproforma'){
                   //this.$router.go(-1)
