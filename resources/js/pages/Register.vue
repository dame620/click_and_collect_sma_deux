  ...
  <div class="wrapper">
    <div class="row">
      <div class="col-left background-2">
        <img
          class="logo"
          src="./assets/imgscomppages/Africa picture.png"
          alt="africa picture"
        />
        <h2>BIENVENUE!</h2>
      </div>
          ...
          <div>
            <form @submit.prevent="onRegister" novalidate>
              ...
              <div class="form-group">
                ...
                <input type="date" v-model="form.dateofbirth" class="form-control" required
            ...
            <div class="social-connection-container">
              ...
              <router-link class="registration" :to="{name: 'login'}">CONNECTEZ VOUS</router-link>
            </div>
          </div>
...
export default {
    ...
    methods: {
        onRegister() {
            ...
            this.form.post('/register').then(({data}) => {
                if (data.success) {
                     ...
                     window.location.href = '/infofor_shipmentdhl';
                       }
                 else{
                ...
                this.$toast.error("Oups, vous avez peut être mal saisi quelque chose.");
            }).finally(_ => {
       ...
       mounted() {
            ...
            console.log("previous route", this.prevRoute.path);
...
.form-group .is-invalid {
    box-shadow: 0 0 0 .2rem rgb(250, 173, 173);
}
...
.language-toggle {
  ...
  font-size: 16px;
  cursor: pointer;
  background: url("./assets/imgscomppages/drop-down-arrow.png") right center
    no-repeat;
